...
const botResponses: Record<string, string> = {
  ...
  timing: 'Most locations: 9 AM - 6 PM, Mon-Fri. Some open weekends too!',
  support: '₹1 = Operations | ₹5 = Distribution | ₹10 = One Bottle. Every rupee helps!',
  donate: "Scroll to 'Support' section. Pick amount. Simple payment. Get receipt!",
  sponsor: 'Yes! Any amount works. ₹10 = 1 bottle for someone in need!',
  payment: 'UPI, cards, all methods accepted. Instant receipt after payment!',
  receipt: 'Auto-generated after payment. Downloadable PDF + WhatsApp share!',
  ...
  track: 'Live monitoring dashboard shows real-time distributions. Check it out!',
  proof: 'Every distribution documented with photos, location, time. All public!',
  transparent: "We show EVERYTHING. If it's not shown, it's not claimed. Simple!",
  ...
  founder: 'Founded by Bala Maneesh Ayanala. He handles everything - operations, transparency, mission.',
  who: 'Jala Vitarana = Water Distribution. Founded by Bala. Mission: Free water for all!',
  bala: 'Bala founded Jala Vitarana. Oversees operations, distribution, and transparency. Full accountability!',
  about: 'Jala Vitarana = Water Democracy platform. Free water for all. 100% transparent. Founded by Bala.',
  company: 'Social initiative, not a company! Mission-driven. Goal: Free water access for everyone.',
  goal: 'Water Democracy! Make clean water free & accessible. Dignified distribution. Zero barriers.',
  goals: 'Short-term: 8+ cities. Long-term: Pan-India. Ultimate: Water for everyone who needs it!',
  vision: 'A world where clean water is a right, not a privilege. Transparent, dignified, free!',
  mission: 'Water Democracy! Free, dignified water access for everyone who needs it!',
  future: 'Expanding to more cities. More sponsors. More water. Same transparency!',
  plan: 'Grow carefully. Add locations. Keep transparency. Scale with support. Stay true!',
  growth: 'Started small. Now 8+ locations. Growing with each sponsor. Sustainable expansion!',
  scale: 'We scale with support! ₹10 = 1 bottle. More sponsors = more locations = more water!',
  expand: 'Adding cities based on demand & sponsors. Next: More metros & tier-2 cities!',
  cities: 'Currently: Hyderabad, Bangalore, Mumbai, Delhi. More coming soon!',
  review: 'Check our live monitoring! Real distributions, real impact. Transparency is our review!',
  reviews: "See live dashboard for real-time proof. Every bottle tracked. That's our review!",
  feedback: 'Love to hear! Email jalavitarana@gmail.com or call +91 8096275914!',
  testimonial: "Our transparency speaks! Check live monitoring for real impact. Numbers don't lie!",
  free: 'Yes! 100% FREE. No cost, no catch. Water is a right!',
  why: "Because clean water should be free for everyone. It's that simple!",
  how: 'I can help! What do you want to know?',
  work: 'Sponsors donate → We distribute → Everyone gets water. Transparent & simple!',
  help: "Ask about: Water, Vouchers, Locations, Support, Contact, Trust. What's up?",
    ...
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="bg-slate-900/95 backdrop-blur-xl rounded-3xl overflow-hidden h-full flex flex-col border-2 border-cyan-500/30 shadow-[0_0_60px_rgba(6,182,212,0.4)]">
              {/* Header */}
